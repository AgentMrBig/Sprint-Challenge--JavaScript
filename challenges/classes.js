...
class CuboidMakerClass{
  ...
  */
 CuboidMakerClass.prototype.volume = function(){
  ...
  */
  const cuboidFromClass = new CuboidMakerClass({
    length: 4,
    width: 5,
    height: 5
  });
...
// Test your volume and surfaceArea methods by uncommenting the logs below:
 console.log("classes.js " + cuboidFromClass.volume()); // 100
 console.log("classes.js " + cuboidFromClass.surfaceArea()); // 130
...
const cubeFromCubeMaker = new CubeMakerClass({
    length: 5,
    width: 5,
    height: 5
  });

console.log(cubeFromCubeMaker.volume());
console.log(cubeFromCubeMaker.surfaceArea());